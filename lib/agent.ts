...
// 1. Tool Declaration for adding a task with optional pre-populated or suggested breakdown steps
...
// 2. Tool Declaration for adding a step to a task
...
// 3. Tool Declaration for updating a task
...
// 4. Tool Declaration for updating an individual step's title or completion status
...
// 5. Tool Declaration for deleting a task
...
// 6. Tool Declaration for deleting a single step from a task
...
// 7. Tool Declaration for listing all tasks
...
// In-Memory Execution of Tools on Tasks array
