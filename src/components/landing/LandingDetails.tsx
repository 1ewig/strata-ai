        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {DETAILS.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="bg-surface-raised border border-edge-raised rounded-3xl p-6 sm:p-8 shadow-card flex items-start gap-4 hover:border-edge-hover transition-all duration-150"
              >
