...
import { popoverVariants } from '@/components/chat/animations';
    ...
    <AnimatePresence>
      {isOpen && commands.length > 0 && (
        <motion.div
          ...
          animate="visible"
          exit="exit"
          className="absolute bottom-full left-0 mb-2 w-full max-w-sm sm:max-w-md bg-surface-raised/95 dark:bg-surface-elevated/95 border border-edge-raised rounded-2xl shadow-card backdrop-blur-xl p-1.5 z-50 origin-bottom-left"
        >
